#' Compare two objects
#'
#' Compare two objects using [compare::compare()], ignoring `spec` attribute and
#' `spec_tbl_df` class by default.
#'
...
#' attr(df3, "problems") <- "b"
#'
#' # Ignore spec attribute and spec_tbl_df class by default
#' compare(df1, df2)
#'
...
#'
compare <- function(
  model, comparison, ignore_attrs = "spec", ignore_classes = "spec_tbl_df", ...
) {
